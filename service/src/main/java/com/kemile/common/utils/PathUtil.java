...
public class PathUtil {
	...
	public static void main(String[] args) {
		System.out.println(PathUtil.getPicturePath("saves",""));
		System.out.println(PathUtil.getPicturePath("visit",""));
	}
	...
	public static String getPicturePath(String pathType, String pathCategory) {
		...
		if ("visit".equals(pathType)) {
			strBuf.append(PathAddress());
			strBuf.append(pathCategory);
		} else if ("save".equals(pathType)) {
			String projectPath = getPorjectPath(request).replaceAll("\\\\", "/");
	...
	private static String getPorjectPath(HttpServletRequest request){
