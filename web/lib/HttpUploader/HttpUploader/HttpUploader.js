...
function HttpUploaderMgr()
{
	...
	this.Config = {
		...
		, "CabPath"			: "http://www.ncmem.com/products/http-uploader5/HttpUploader.cab"
	    , "UrlCreate"       : "http://localhost:8080/HttpUploader5ChrUtf8/db/ajax_create.jsp"
		...
		, "CabPath64"		: "http://www.ncmem.com/products/http-uploader5/HttpUploader64.cab"
		//Firefox
		, "CabPathFirefox"	: "http://www.ncmem.com/products/http-uploader5/HttpUploader5.xpi"
		, "MimeType"		: "application/npHttpUploader5"
		//Chrome
		, "CabPathChrome"	: "http://www.ncmem.com/products/http-uploader5/HttpUploader5.crx"
		, "MimeTypeChr"		: "application/chrHttpUploader5"
		, "CrxName"			: "chrHttpUploader5"
		, "SetupPath"		: "http://localhost:8080/HttpUploader5ChrUtf8/HttpUploader/setup.htm"
	...
	{
		$("#pnlHeader").html('<a href="' + _this.Config["SetupPath"] + '" target="_blank">请先安装控件</a>');
	};
